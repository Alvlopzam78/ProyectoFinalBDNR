...
# Conexión a Neo4j
graph = Graph("bolt://13.57.206.177:7687", auth=("neo4j", "CONTRASEÑA_AQUI"))  # Reemplaza con tus credenciales y dirección IP
...
# Generar y ejecutar las consultas Cypher dentro de la transacción
for item in data:
    node = Node("Character",
                id=item['id'],
                name=item['name'],
